...
bool PostureColorize::start() {
  ...
  calibration_reader_ =
      unique_ptr<posture::CalibrationReader>(new posture::CalibrationReader(calibration_path_));
...
bool PostureColorize::disconnect(std::string /*unused*/) { return true; }

bool PostureColorize::disconnect_all() { return true; }

bool PostureColorize::can_sink_caps(std::string caps) {
...
bool PostureColorize::check_image_caps(string caps,
                                       unsigned int& width,
                                       unsigned int& height,
